...
function mpesa_row_meta( $links, $file )
{
	...
	if ( $plugin == $file ) {
		$row_meta = array( 
			'github'    => '<a href="' . esc_url( 'https://github.com/dennis2018/Safaricom-Mpesa-APIs-B2C-B2C-C2B-/' ) . '" target="_blank" aria-label="' . esc_attr__( 'Contribute on Github', 'woocommerce' ) . '">' . esc_html__( 'Github', 'woocommerce' ) . '</a>',
			...
			'pro' => '<a href="' . esc_url( 'https://www.dennismburu.tech/' ) . '" target="_blank" aria-label="' . esc_attr__( 'Get Pro Version', 'woocommerce' ) . '">' . esc_html__( 'Get pro', 'woocommerce' ) . '</a>'
		 );
